      ...
      <div className=" w-[100%] h-[100px] pl-[25px] border border-solid border-orange-50 flex flex-row justify-between items-center">
        <div className=" flex flex-row justify-center items-center gap-[30px]">
          ...
          <div className=" w-[50px] h-[50px] flex justify-center items-center bg-[#212121] rounded-[100%] hover:cursor-pointer">
            ...
            >
              <path
                d="M5 26.25V11.25L15 3.75L25 11.25V26.25H17.5V17.5H12.5V26.25H5Z"
                fill="white"
              />
            </svg>
          </div>
        </div>
        <div className=" w-[550px] h-[40px] text-[24px] font-leckerli text-[white] flex justify-center items-center rounded-tl-3xl rounded-bl-3xl rounded-tr-3xl rounded-br-3xl bg-[#212121]">
          Hello! What do you want to hear today?
        </div>
        {username ? (
          ...
          <div className="flex flex-row gap-20px">
            <Link to="/RegisterPage">
              <button className="w-[100px] h-[40px] text-[16px] text-[white] flex justify-center items-center rounded-tl-3xl rounded-bl-3xl rounded-tr-3xl rounded-br-3xl bg-[#212121]">
                Sign up
              </button>
            </Link>
            <Link to="/LoginPage">
              <button className="w-[100px] h-[40px] text-[16px] text-[black] flex justify-center items-center rounded-tl-3xl rounded-bl-3xl rounded-tr-3xl rounded-br-3xl bg-[white]">
                Log in
              </button>
            </Link>
          </div>
