...
const RegisterPage = () => {
  ...
  return (
    <div className="w-[100vw] h-[100vh] bg-[#121212] flex justify-center items-center">
      <div className=" w-[400px] h-[100%] flex flex-col justify-center items-center gap-[30px]">
        <svg
          width="74"
          height="74"
          viewBox="0 0 74 74"
        ...
        <div className="w-[100%] flex flex-col gap-[20px] justify-center items-center">
          ...
          <Input
            ...
            onGetdData={getPassword}
            type="password"
          />
          <Input
            placeholder="Confirm Password"
            onGetdData={getConfirm}
            type="password"
          />
        </div>
        <div className="flex flex-col justify-center items-center gap-[8px]">
          <button
            className=" w-[360px] h-[50px] flex justify-center items-center text-[24px] bg-[#00DB0B] rounded-tl-3xl rounded-bl-3xl rounded-tr-3xl rounded-br-3xl"
